...
public class InterviewTwitterApplication {
  ...
  public static class BootstrapBitcoinEvangelists implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
      ...
      User andreasAntonopoulos = userRepository.save(new User("aantonop", "password", "Anto","nop"));
      User vitalikButerin = userRepository.save(new User("VitalikButerin", "password","Vitali", "buterin"));
      User charlieLee = userRepository.save(new User("SatoshiLite", "password","Satoshi","Ishi"));
